...
namespace ExampleMod.Projectiles
{
    public class ExampleLastPrismHoldout : ModProjectile
    {
        ...
        private void FireBeams()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, beamVelocity, ProjectileType<ExampleLastPrismBeam>(), damage, knockback, Projectile.owner, b, uuid);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = TextureAssets.Projectile[Type].Value;//Main.ProjectileTexture[Projectile.type];
